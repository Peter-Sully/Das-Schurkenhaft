...
public class CombatSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyPrefabs[0] = Resources.Load<GameObject>("Prefabs/SPUM_20240911215637878"); //this needs to change when you add more enemies*/
    ...
    void SpawnEnemies()
    {
        ...
        enemyPrefabs = CombatManager.Instance.enemiesForCombat.ToArray();
        if (enemyPrefabs == null || enemyPrefabs.Length == 0) Debug.LogError("No enemies found!");
        for (int i = 0; i < enemySpawnPoints.Length; i++)
        {
            ...
            enemyCombat.InitializeEnemy(enemyCombat.enemyName);
